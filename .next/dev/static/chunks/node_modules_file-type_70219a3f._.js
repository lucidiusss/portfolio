...
"[project]/node_modules/file-type/util.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function tarHeaderChecksumMatches(arrayBuffer, offset = 0) {
    const readSum = Number.parseInt(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["StringType"](6).get(arrayBuffer, 148).replace(/\0.*$/, '').trim(), 8); // Read sum in header
...
"[project]/node_modules/file-type/supported.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/file-type/core.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tokenizer$2f$inflate$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@tokenizer/inflate/lib/index.js [client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tokenizer$2f$inflate$2f$lib$2f$ZipHandler$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tokenizer/inflate/lib/ZipHandler.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tokenizer$2f$inflate$2f$lib$2f$GzipHandler$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tokenizer/inflate/lib/GzipHandler.js [client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$type$2f$util$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/file-type/util.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$type$2f$supported$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/file-type/supported.js [client] (ecmascript)");
;
;
;
;
...
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tokenizer$2f$inflate$2f$lib$2f$ZipHandler$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ZipHandler"].prototype.inflate = async function(zipHeader, fileData, callback) {
...
function isRecoverableZipError(error) {
    if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$strtok3$2f$lib$2f$stream$2f$Errors$2e$js__$5b$client$5d$__$28$ecmascript$29$__["EndOfStreamError"]) {
        return true;
    }
...
class FileTypeParser {
    ...
    async fromBuffer(input) {
        ...
        return this.fromTokenizer(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$strtok3$2f$lib$2f$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["fromBuffer"](buffer, this.tokenizerOptions));
    }
    async fromBlob(blob) {
        const tokenizer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$strtok3$2f$lib$2f$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["fromBlob"](blob, this.tokenizerOptions);
        try {
    ...
    async fromStream(stream) {
        const tokenizer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$strtok3$2f$lib$2f$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["fromWebStream"](stream, this.tokenizerOptions);
        try {
            return await this.fromTokenizer(tokenizer);
        } finally{
            await tokenizer.close();
    ...
    checkString(header, options) {
        return this.check((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$type$2f$util$2e$js__$5b$client$5d$__$28$ecmascript$29$__["stringToBytes"])(header, options?.encoding), options);
    }
    ...
    detectConfident = async (tokenizer)=>{
        ...
        if (this.check([
            ...
            const gzipHandler = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tokenizer$2f$inflate$2f$lib$2f$GzipHandler$2e$js__$5b$client$5d$__$28$ecmascript$29$__["GzipHandler"](tokenizer);
        ...
        if (this.checkString('ID3')) {
            ...
            const id3HeaderLength = await tokenizer.readToken(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$type$2f$util$2e$js__$5b$client$5d$__$28$ecmascript$29$__["uint32SyncSafeToken"]);
        ...
        if (this.check([
            ...
            try {
                await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tokenizer$2f$inflate$2f$lib$2f$ZipHandler$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ZipHandler"](tokenizer).unzip((zipHeader)=>{
        ...
        if (this.check([
            ...
            async function readField() {
                const msb = await tokenizer.peekNumber(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UINT8"]);
                let mask = 0x80;
            ...
            async function readElement() {
                ...
                return {
                    id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8array$2d$extras$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getUintBE"])(idView),
                    len: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8array$2d$extras$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getUintBE"])(lengthView)
                };
            }
            async function readChildren(children) {
                ...
                while(children > 0){
                    ...
                    if (element.id === 0x42_82) {
                        ...
                        const rawValue = await tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["StringType"](documentTypeLength));
        ...
        if (this.check([
            ...
            const machOArchitectureCount = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UINT32_BE"].get(this.buffer, 4);
            const javaClassFileMajorVersion = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UINT16_BE"].get(this.buffer, 6);
        ...
        if (this.checkString('AC')) {
            const version = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["StringType"](4, 'latin1').get(this.buffer, 2);
        ...
        if (this.checkString('!<arch>')) {
            ...
            const string = await tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["StringType"](13, 'ascii'));
        ...
        if (this.check([
            ...
            async function readChunkHeader() {
                return {
                    length: await tokenizer.readToken(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["INT32_BE"]),
                    type: await tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["StringType"](4, 'latin1'))
                };
            }
                ...
                switch(chunk.type){
                    ...
                    default:
                        ...
                        try {
                            ...
                            if (!isUnknownPngStream && (error instanceof ParserHardLimitError || error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$strtok3$2f$lib$2f$stream$2f$Errors$2e$js__$5b$client$5d$__$28$ecmascript$29$__["EndOfStreamError"])) {
                                return pngFileType;
                            }
                            throw error;
                        }
        ...
        if (this.checkString('ftyp', {
            ...
            const brandMajor = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["StringType"](4, 'latin1').get(this.buffer, 8).replace('\0', ' ').trim();
            switch(brandMajor){
                case 'avif':
                case 'avis':
                    return {
        ...
        if (this.check([
            ...
            try {
                async function readHeader() {
                    ...
                    return {
                        id: guid,
                        size: Number(await tokenizer.readToken(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UINT64_LE"]))
                    };
                }
                ...
                if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$strtok3$2f$lib$2f$stream$2f$Errors$2e$js__$5b$client$5d$__$28$ecmascript$29$__["EndOfStreamError"] || error instanceof ParserHardLimitError) {
        ...
        if (this.check([
            ...
            const type = await tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["StringType"](4, 'ascii'));
            switch(type){
                case 'jp2 ':
                    return {
                        ext: 'jp2',
        ...
        if (this.checkString('ustar', {
            ...
            offset: 257
        }) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$type$2f$util$2e$js__$5b$client$5d$__$28$ecmascript$29$__["tarHeaderChecksumMatches"])(this.buffer)) {
            return {
                ext: 'tar',
    ...
    async readTiffTag(bigEndian) {
        const tagId = await this.tokenizer.readToken(bigEndian ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UINT16_BE"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UINT16_LE"]);
...
const supportedExtensions = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$type$2f$supported$2e$js__$5b$client$5d$__$28$ecmascript$29$__["extensions"]);
const supportedMimeTypes = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$type$2f$supported$2e$js__$5b$client$5d$__$28$ecmascript$29$__["mimeTypes"]);
}),
]);

//# sourceMappingURL=node_modules_file-type_70219a3f._.js.map