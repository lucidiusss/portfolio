    ...
    return (
        <div className="flex items-center gap-5">
            {/*<Button
                ...
                className={`${audio.isShuffled ? "border-neutral-400 text-neutral-400 hover:border-neutral-300 hover:text-neutral-300" : "border-transparent"} border-2 rounded-lg w-12 h-12 p-4  bg-neutral-900 hover:bg-neutral-800 text-[#a1a1a1] hover:text-white`}
            >
                <Shuffle className="border border-transparent w-6 h-6" />
            </Button>*/}
            <Button
            ...
            >
                <SkipBack className="border border-transparent w-6 h-6" />
            </Button>
            <Button
            ...
            >
                {!audio.isPlaying ? (
                    <Play className="border border-transparent w-6 h-6" />
                ) : (
                    <Pause className="border border-transparent w-6 h-6" />
                )}
            </Button>
            <Button
                ...
                className="  rounded-lg w-12 h-12 p-4  bg-neutral-900 hover:bg-neutral-800 text-[#a1a1a1] hover:text-white"
            >
                <SkipForward className="border border-transparent w-6 h-6" />
            </Button>
            {/*<Button
